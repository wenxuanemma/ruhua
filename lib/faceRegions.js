...
export const FACE_REGIONS = {
  ...
  mingdaidihou_taizu: {
    empress     : { x:0.1733, y:0.4100, w:0.1746, h:0.2580, angle:0, faceAngle:'front', foreheadClip:true, skinSample:{ cx:0.2687, cy:0.4686, r:0.0193 } },
    emperor     : { x:0.6535, y:0.4160, w:0.1692, h:0.2360, angle:0, faceAngle:'front', foreheadClip:true, skinSample:{ cx:0.7794, cy:0.5359, r:0.0215 } },
  },
  mingdaidihou_xuanzong: {
    empress     : { x:0.1977, y:0.4060, w:0.1258, h:0.2500, angle:0, faceAngle:'front', foreheadClip:true, skinSample:{ cx:0.2986, cy:0.5685, r:0.0189 } },
    emperor     : { x:0.6603, y:0.4020, w:0.1353, h:0.2540, angle:0, faceAngle:'front', foreheadClip:true, skinSample:{ cx:0.7659, cy:0.5471, r:0.0203 } },
  },
