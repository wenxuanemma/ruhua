...
// Updated by calibrate tool at 2026-06-25T16:01:34.461Z
...
export const FACE_REGIONS = {
  ...
  gongle: {
    pipa        : { x:0.6747, y:0.0520, w:0.0512, h:0.0980, angle:-1, faceAngle:'front', colorShift:1.00, rMax:0.92, bMax:0.93, skinSample:{ cx:0.6961, cy:0.0817, r:0.0080 } },
    guzheng     : { x:0.4888, y:0.0780, w:0.0456, h:0.0940, angle:20, faceAngle:'front', colorShift:1.00, rMax:0.92, bMax:0.93, skinSample:{ cx:0.4990, cy:0.1451, r:0.0080 } },
    clapper     : { x:0.1844, y:0.0090, w:0.0397, h:0.0900, angle:20, faceAngle:'front', colorShift:1.00, rMax:0.92, bMax:0.93, skinSample:{ cx:0.2084, cy:0.0375, r:0.0080 } },
    listener    : { x:0.7743, y:0.4100, w:0.0524, h:0.0960, angle:-5, faceAngle:'front', colorShift:1.00, rMax:0.92, bMax:0.93, skinSample:{ cx:0.7963, cy:0.4864, r:0.0080 } },
  },
  daolian: {
  ...
  tiaoqin: {
    lady        : { x:0.2159, y:0.3020, w:0.0349, h:0.1360, angle:-7, faceAngle:'front', colorShift:1.00, rMax:0.88, bMax:1.20, skinSample:{ cx:0.2410, cy:0.3864, r:0.0080 } },
    seated      : { x:0.7216, y:0.1460, w:0.0370, h:0.1500, angle:10, faceAngle:'front', colorShift:1.00, rMax:0.88, bMax:1.20, skinSample:{ cx:0.7447, cy:0.2415, r:0.0080 } },
  },
  huishan: {
    center      : { x:0.7563, y:0.1218, w:0.0165, h:0.1192, angle:-11, faceAngle:'front', skinSample:{ cx:0.7669, cy:0.2027, r:0.0080 } },
    seated      : { x:0.8380, y:0.3744, w:0.0171, h:0.1192, angle:11, faceAngle:'front', skinSample:{ cx:0.8483, cy:0.4553, r:0.0080 } },
  },
};
