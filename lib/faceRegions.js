...
export const FACE_REGIONS = {
  ...
  hanxizai: {
    guest       : { x:0.7647, y:0.0200, w:0.0989, h:0.1420, angle:5 },
    host        : { x:0.3646, y:0.2820, w:0.0936, h:0.1620, angle:-3 },
    dancer      : { x:0.0798, y:0.3500, w:0.0807, h:0.1260, angle:-5 },
  },
  bunianta: {
    official    : { x:0.7248, y:0.3620, w:0.0479, h:0.1420, angle:3 },
    envoy       : { x:0.3521, y:0.3540, w:0.0489, h:0.1260, angle:-5 },
  },
  guoguo: {
    lady        : { x:0.3820, y:0.1805, w:0.0660, h:0.1401, angle:0 },
    attendant   : { x:0.6321, y:0.3494, w:0.0900, h:0.1800, angle:3 },
    rider       : { x:0.8081, y:0.2565, w:0.0276, h:0.1136, angle:-5 },
  },
  luoshen: {
  ...
  gongle: {
    ...
    musician    : { x:0.6663, y:0.0360, w:0.0863, h:0.1140, angle:-8 },
    serving     : { x:0.7680, y:0.3830, w:0.0789, h:0.1220, angle:2 },
  },
};
