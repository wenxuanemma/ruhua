...
// Updated by calibrate tool at 2026-06-16T19:49:13.923Z
...
export const FACE_REGIONS = {
  ...
  hanxizai: {
    ...
    host        : { x:0.3569, y:0.3000, w:0.0749, h:0.1260, angle:-3, faceAngle:'three_quarter_left', colorShift:0.95, faceSize:0.6, faceCenter:{ cx:0.4500, cy:0.6300 }, skinSample:{ cx:0.3990, cy:0.3779, r:0.0080 }, disabled:true }, disabled:true },
    dancer      : { x:0.1093, y:0.3660, w:0.0574, h:0.1160, angle:7, faceAngle:'profile_right', faceSize:0.62, faceCenter:{ cx:0.5000, cy:0.4800 }, skinSample:{ cx:0.1372, cy:0.4442, r:0.0080 }, disabled:true }, disabled:true },
  },
  bunianta: {
