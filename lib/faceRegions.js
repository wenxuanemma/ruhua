...
export const FACE_REGIONS = {
  ...
  gongle: {
    pipa        : { x:0.6747, y:0.0520, w:0.0512, h:0.0980, angle:-1, faceAngle:'front', exactSample:true, skinSample:{ cx:0.6961, cy:0.0817, r:0.0080 } },
    guzheng     : { x:0.4888, y:0.0780, w:0.0456, h:0.0940, angle:20, faceAngle:'front', exactSample:true, skinSample:{ cx:0.4990, cy:0.1451, r:0.0080 } },
    clapper     : { x:0.1844, y:0.0090, w:0.0397, h:0.0900, angle:20, faceAngle:'front', exactSample:true, skinSample:{ cx:0.2084, cy:0.0375, r:0.0080 } },
    listener    : { x:0.7743, y:0.4100, w:0.0524, h:0.0960, angle:-5, faceAngle:'front', exactSample:true, skinSample:{ cx:0.7963, cy:0.4864, r:0.0080 } },
  },
  daolian: {
