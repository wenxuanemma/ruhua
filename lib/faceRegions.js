...
export const FACE_REGIONS = {
  ...
  mingdaidihou_taizu: {
    empress     : { x:0.1977, y:0.4180, w:0.1285, h:0.2500, angle:0, faceAngle:'front', foreheadClip:true, widthCalibrated:true, bMax:1.60, skinSample:{ cx:0.2687, cy:0.4686, r:0.0193 } },
    emperor     : { x:0.6698, y:0.4060, w:0.1394, h:0.2460, angle:0, faceAngle:'front', foreheadClip:true, widthCalibrated:true, bMax:1.60, skinSample:{ cx:0.7794, cy:0.5359, r:0.0215 } },
  },
  mingdaidihou_xuanzong: {
    empress     : { x:0.1977, y:0.4200, w:0.1204, h:0.2360, angle:-2, faceAngle:'front', foreheadClip:true, widthCalibrated:true, bMax:1.60, skinSample:{ cx:0.2620, cy:0.4625, r:0.0189 } },
    emperor     : { x:0.6644, y:0.4020, w:0.1312, h:0.2540, angle:1, faceAngle:'front', foreheadClip:true, widthCalibrated:true, bMax:1.60, skinSample:{ cx:0.7659, cy:0.5471, r:0.0203 } },
  },
  mingdaidihou_xiaozong: {
    empress     : { x:0.2085, y:0.3960, w:0.1095, h:0.2420, angle:0, faceAngle:'front', foreheadClip:true, widthCalibrated:true, bMax:1.60, skinSample:{ cx:0.2959, cy:0.5433, r:0.0164 } },
    emperor     : { x:0.6820, y:0.4220, w:0.1068, h:0.2140, angle:0, faceAngle:'front', foreheadClip:true, widthCalibrated:true, bMax:1.60, skinSample:{ cx:0.7679, cy:0.5511, r:0.0160 } },
  },
};
