...
export const FACE_REGIONS = {
  ...
  hanxizai: {
    guest       : { x:0.7895, y:0.0380, w:0.0740, h:0.1180, angle:17, faceAngle:'front',            colorShift:0.95 },
    host        : { x:0.3569, y:0.3000, w:0.0749, h:0.1260, angle:-3, faceAngle:'three_quarter_left', colorShift:0.95 },
