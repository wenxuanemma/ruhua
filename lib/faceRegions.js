...
// Updated by calibrate tool at 2026-05-08T20:38:08.814Z
...
export const FACE_REGIONS = {
  ...
  hanxizai: {
    guest       : { x:0.7895, y:0.0380, w:0.0740, h:0.1180, angle:17, faceAngle:'front',            colorShift:0.85 },
    host        : { x:0.3569, y:0.3000, w:0.0749, h:0.1260, angle:-3, faceAngle:'three_quarter_left', colorShift:0.85 },
    dancer      : { x:0.1093, y:0.3740, w:0.0558, h:0.1080, angle:7,  faceAngle:'profile_right' },
  },
  bunianta: {
