...
export const FACE_REGIONS = {
  ...
  hanxizai: {
    ...
    host        : { x:0.3569, y:0.3000, w:0.0749, h:0.1260, angle:-3, faceAngle:'three_quarter_left', colorShift:0.95, skinSample:{ cx:0.3990, cy:0.3779, r:0.0080 }, faceSize:0.70 },
    dancer      : { x:0.1093, y:0.3740, w:0.0558, h:0.1080, angle:7, faceAngle:'profile_right', skinSample:{ cx:0.1372, cy:0.4442, r:0.0080 }, faceSize:0.80 },
  },
  bunianta: {
