...
const PAINTINGS = [
  ...
  },
  {
    ...
    figures: [
      { id:'guest',  name:'宾客',   nameEn:'Honored Guest',    descZh:'夜宴宾客，立于烛光之侧，见证这场盛宴的繁华与忧郁。',         descEn:'A guest at the night banquet, standing in the lamplight, witnessing the splendor and melancholy of this storied gathering.', gender:'man',   rec:true },
      { id:'host',   name:'韩熙载', nameEn:'Han Xizai (Host)', descZh:'南唐重臣，以纵情声色掩饰政治落寞，夜宴的主人与灵魂。',       descEn:'A high minister of Southern Tang who masked political despair with revelry — the host and soul of the banquet.', gender:'man',   rec:true,  disabled:true },
      { id:'dancer', name:'舞伎',   nameEn:'Court Dancer',     descZh:'宴席上的舞者，以曼妙舞姿点亮烛光夜宴，是这场盛宴的华彩。',   descEn:'The dancer of the banquet, whose graceful movements illuminate the candlelit night and crown the evening with brilliance.', gender:'woman', rec:false, disabled:true },
    ],
    youAre: '宾客 · Honored Guest',
    context: 'Emperor Li Yu secretly sent painter Gu Hongzhong to spy on Han Xizai\'s private banquets. The result: five scenes of music, dance, and political melancholy in one of history\'s most intimate court scrolls.',
    contextZh: '南唐后主李煜派画家顾闳中潜入韩熙载府邸，秘密记录其夜宴情形。画卷呈现音乐、歌舞与政治忧郁，是中国历史上最具私密感的宫廷长卷之一。',
  ...
  },
  {
    ...
    color: '#925068',
    figures: [
      { id:'listener', name:'听乐仕女', nameEn:'Lady of the Court',  descZh:'静坐聆听，沉浸于丝竹之声，是宴席间最从容优雅的存在。',     descEn:'Seated in quiet contemplation, lost in the sound of strings and flutes — the most serene presence at the gathering.', gender:'woman', rec:true },
      { id:'musician', name:'琵琶仕女', nameEn:'Pipa Musician',      descZh:'轻拨琵琶，以指尖流淌的乐音为宴席增添盛唐风华。',           descEn:'Plucking the pipa with delicate fingers, weaving the flourishing music of the Tang into the air of the gathering.', gender:'woman', rec:true },
      { id:'serving',  name:'侍女',     nameEn:'Serving Attendant',  descZh:'穿梭于席间，以无声的细心侍奉，成就这场雅集的从容与温润。', descEn:'Moving quietly among the guests, attending with graceful discretion to the ease and warmth of the gathering.', gender:'woman', rec:true },
    ],
    ...
    contextZh: '十位唐代宫廷仕女围坐漆桌，或奏琵琶、箜篌、横笛，或静静聆听。丰腴的体态与繁复的发饰，体现了盛唐开放包容的审美风貌。',
    scene: 'In the imperial garden, music rises around the lacquered table — osmanthus wine, half-moon overhead, the full splendor of Tang drifting through the evening air.',
    sceneZh: '御苑之中，丝竹声绕漆桌而起，桂花酒盈樽，半月当空，盛唐的华美在夜风中悠然流淌。',
  },
  {
    ...
    figures: [
      { id:'ironer',   name:'熨绢仕女', nameEn:'Lady Ironing Silk',   descZh:'以热熨斗轻抚绢帛，将丝绸熨烫平整，动作沉稳而专注。',       descEn:'Smoothing silk with a heated iron, pressing the fabric with steady, focused hands in the rhythm of the weaving chamber.', gender:'woman', rec:true },
      { id:'threader', name:'穿针仕女', nameEn:'Lady Threading Silk', descZh:'细心穿针引线，将练丝精准穿入针孔，是织造工序中最考验耐心之人。', descEn:'Threading silk with patient precision through the needle\'s eye — the most careful and exacting work of the silk-making process.', gender:'woman', rec:true },
    ],
    youAre: '熨绢仕女 · Lady of the Silk Chamber',
    context: 'Zhang Xuan\'s original is lost; this Song dynasty copy by Emperor Huizong depicts three groups of Tang court ladies processing newly woven silk — pounding, threading, and ironing. Held at the Museum of Fine Arts, Boston.',
    contextZh: '张萱原作已佚，此为宋徽宗摹本，描绘唐代宫廷仕女捣练、络线、熨绢三组劳作场景，现藏美国波士顿美术馆。',
  ...
  },
  {
    ...
    color: '#7a5028',
    figures: [
      { id:'topleft',   name:'左侧仕女', nameEn:'Lady with Child',   descZh:'怀抱婴孩，神情温柔专注，是内廷生活中最动人的温情一幕。',     descEn:'Cradling a child with gentle, focused care — the most tender and intimate moment of inner palace life.', gender:'woman', rec:true },
      { id:'topcenter', name:'中央仕女', nameEn:'Lady of the Court', descZh:'端坐于画面中央，仪态从容，见证着宫苑中孩童嬉戏的欢乐时光。', descEn:'Seated at the center of the scene with composed grace, presiding over the joyful play of children in the palace garden.', gender:'woman', rec:true },
    ],
  ...
  },
  {
    ...
    directImageUrl: '/paintings/tiaoqin.jpg',
    title: '调琴啜茗图',
    sub: 'Ladies Tuning the Lute and Tasting Tea',
    subZh: '唐周昉绘宫廷仕女调琴品茗图',
    dynasty: '唐',
    dynastyFull: 'Tang Dynasty · c. 8th–9th century CE',
    dynastyFullZh: '唐代 · 约8至9世纪',
    ...
    figures: [
      { id:'lady',      name:'调琴仕女', nameEn:'Lady at the Lute', descZh:'轻拨琴弦，以指尖的律动传递内心的雅致与从容，是园中最动人的风景。', descEn:'Tuning the qin with unhurried fingers, her inner elegance expressed through each gentle pluck of the strings.', gender:'woman', rec:true },
      { id:'attendant', name:'品茗仕女', nameEn:'Lady Tasting Tea', descZh:'细啜香茗，于宁静中品味茶香，举手投足间尽显唐代贵族女性的雅趣。',   descEn:'Savoring tea in quiet contemplation, every gesture a portrait of the refined taste of Tang aristocratic womanhood.', gender:'woman', rec:true },
    ],
    youAre: '调琴仕女 · Lady of Refined Taste',
    ...
    contextZh: '唐代仕女画大家周昉，描绘贵族园中仕女闲居之景：一人调拨琴弦，一人细啜香茗，尽显唐代上层女性的雅致闲情。',
    scene: 'In a walled garden fragrant with osmanthus, the qin sounds and tea steams — the afternoon stretching out in perfect, unhurried elegance.',
    sceneZh: '桂香幽幽的围墙园中，琴声低回，茶香袅袅，午后时光在从容雅致中悠然流淌。',
  },
  {
    id: 'huishan',
    directImageUrl: '/paintings/huishan.jpg',
    ...
    youAre: '宾客 · Honored Guest',
    context: 'Emperor Li Yu secretly sent painter Gu Hongzhong to spy on Han Xizai\'s private banquets. The result: five scenes of music, dance, and political melancholy in one of history\'s most intimate court scrolls.',
    contextZh: '南唐后主李煜派画家顾闳中潜入韩熙载府邸，秘密描绘其夜宴情形。画卷分五段，呈现音乐、歌舞与政治忧郁，是中国历史上最具私密感的宫廷长卷之一。',
    ...
    sceneZh: '你在烛光下落座于韩熙载身旁，聆听琵琶，望着这个注定覆灭的南唐朝廷在身边绚烂而短暂地燃烧。',
  },
  {
    id: 'gongle',
    directImageUrl: '/paintings/gongle.jpg',
    ...
    sceneZh: '你斜倚于御苑宴席之旁，手持桂花酒，半月初升，紫藤盛开，夜乐悠然而起。',
  },
  {
    id: 'daolian',
    directImageUrl: '/paintings/daolian.jpg',
    ...
    context: 'Zhang Xuan\'s original is lost; this Song dynasty copy by Emperor Huizong depicts three groups of Tang court ladies processing newly woven silk — pounding, threading, and ironing. Held at the Museum of Fine Arts, Boston.',
    contextZh: '张萱原作已佚，此为宋徽宗摹本，描绘唐代宫廷仕女捣练、络线、熨绢三组劳作场景，现藏美国波士顿美术馆。',
    scene: 'In the imperial weaving chamber on a warm afternoon, you smooth the silk with a heated iron, the fabric gleaming under the light — hands moving in the ancient rhythm of the court.',
    sceneZh: '暖午时分，你在宫中织室以热熨斗轻抚绢帛，丝光在光线下流动，双手遵循着千年不变的宫廷节律。',
  },
  {
    id: 'yinger',
    directImageUrl: '/paintings/yinger.jpg',
    ...
    context: 'Tang court ladies at leisure with children in the imperial palace. The full-figured beauties and playful children capture the warmth and intimacy of inner court life at its most unguarded. Held at the Metropolitan Museum of Art (CC0).',
    contextZh: '唐代宫廷仕女与孩童嬉戏于宫苑之中，丰腴的美人与活泼的婴孩，呈现出内廷生活最温情、最自在的一面。现藏美国大都会艺术博物馆（CC0）。',
    scene: 'In the inner palace on a quiet afternoon, you tend to the children of the imperial household — their laughter filling the gilded rooms as afternoon light filters through silk screens.',
    sceneZh: '宁静的午后，你在内廷照看皇家孩童，笑声在金碧辉煌的宫室中回荡，午后的光线透过丝屏轻柔洒落。',
  },
  {
    id: 'tiaoqin',
    directImageUrl: '/paintings/tiaoqin.jpg',
    ...
    context: 'Zhou Fang, master of Tang court beauty painting, depicts ladies in an aristocratic garden — one tuning a qin lute, another savoring tea. The painting epitomizes the cultivated leisure of Tang elite women.',
    contextZh: '唐代仕女画大家周昉，描绘贵族园中仕女闲居之景：一人调拨琴弦，一人细啜香茗，尽显唐代上层女性的雅致闲情。',
    scene: 'In a walled garden fragrant with osmanthus, you pluck the strings of the qin as a servant brings tea — the afternoon stretching out in perfect, unhurried elegance.',
    sceneZh: '桂香幽幽的围墙园中，你轻拨琴弦，侍女奉上香茗，午后时光在从容雅致中悠然流淌。',
  },
  {
    id: 'huishan',
    directImageUrl: '/paintings/huishan.jpg',
    ...
    context: 'Zhou Fang\'s masterpiece of Tang court beauty depicts ladies in summer leisure — holding fans, vases, and accessories in the palace gardens. The melancholic stillness beneath the surface elegance made this one of the most celebrated figure paintings of the Tang dynasty.',
    contextZh: '周昉传世名作，描绘盛夏宫苑中仕女闲居之态：执扇、持瓶、把玩器物，华美之下流露出淡淡的忧郁与倦意，是唐代人物画中最受推崇的作品之一。',
    scene: 'In the summer palace courtyard, you carry a celadon vase through the afternoon heat, silk robes heavy and perfumed — the languid beauty of a court that seems eternal, and is not.',
    sceneZh: '盛夏宫苑，你手持青瓷瓶穿行于午后的暑热中，丝袍沉重而芬芳——这繁华似乎永恒，却终将逝去。',
  },
];
