...
const PAINTINGS = [
  ...
  },
  {
    ...
    figures: [
      ...
      { id:'musician', name:'琵琶仕女', en:'Pipa Musician',      pose:'Near-frontal', rec:true },
  ...
  },
  {
    ...
    color: '#9a7840',
    figures: [
      { id:'ironer',   name:'熨绢仕女', en:'Lady Ironing Silk',   pose:'Near-frontal', rec:true },
      { id:'threader', name:'穿针仕女', en:'Lady Threading Silk', pose:'Near-frontal', rec:true },
    ],
  ...
  },
  {
    ...
    color: '#7a5028',
    figures: [
      { id:'topleft',   name:'左侧仕女', en:'Lady with Child',    pose:'Near-frontal', rec:true },
      { id:'topcenter', name:'中央仕女', en:'Lady of the Court',  pose:'Near-frontal', rec:true },
    ],
  ...
  },
  {
    ...
    color: '#506840',
    figures: [
      { id:'lady',      name:'调琴仕女', en:'Lady at the Lute',  pose:'Near-frontal', rec:true },
      { id:'attendant', name:'品茗仕女', en:'Lady Tasting Tea',  pose:'Near-frontal', rec:true },
    ],
  ...
  },
  {
    ...
    color: '#584870',
    figures: [
      { id:'center', name:'执瓶仕女', en:'Lady with Vase',     pose:'Near-frontal', rec:true },
      { id:'seated', name:'倚坐仕女', en:'Seated Court Lady',  pose:'Near-frontal', rec:true },
    ],
