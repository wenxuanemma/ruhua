...
const PAINTINGS = [
  ...
  },
  {
    ...
    context: 'These formal court portraits, preserved in the Qing-dynasty Nanxundian collection, depict Ming founder Zhu Yuanzhang and his empress Ma in old age. Unlike flattering idealized portraiture, Ming imperial portraits were prized for unflinching realism — every wrinkle and feature rendered true to life.',
    contextZh: '这组正式宫廷画像出自清代南薰殿旧藏，描绘明代开国皇帝朱元璋与孝慈高皇后晚年容貌。明代帝后像素以写实著称，不加美化，一笔一划皆求形神毕肖。',
  ...
  },
  {
    ...
    context: 'Zhu Zhanji presided over the "Renxuan Reign," an era of peace and prosperity still remembered as a high point of Ming governance. An accomplished painter himself, he is portrayed here beside Empress Sun in the formal Nanxundian court style.',
    contextZh: '朱瞻基在位期间开创「仁宣之治」，是明代公认的盛世之一。他本人亦擅丹青，此像与孙皇后并列南薰殿藏画之中，尽显宫廷正统气度。',
  ...
  },
  {
    ...
    context: 'Zhu Youtang is celebrated as the most faithful emperor in Chinese history — he took no concubines and remained devoted solely to Empress Zhang throughout his reign, an extraordinary choice for a Ming sovereign. Together they preside over what historians call the "Hongzhi Restoration."',
    contextZh: '朱祐樘是中国历史上罕见的「专一」帝王，终其一生未纳妃嫔，与张皇后相伴始终，开创「弘治中兴」的清明之治，被后世誉为明代最深情的帝王。',
