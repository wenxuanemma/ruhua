...
const PAINTINGS = [
  ...
  },
  {
    ...
    dynasty: '唐',
    dynastyFull: 'Tang Dynasty · c. 752 CE',
    artist: '张萱',
    artistFull: '张萱 Zhang Xuan',
    tagZh: '宫廷出游',
    tagEn: 'Court Procession',
    grad: 'linear-gradient(148deg,#1a0e08 0%,#3d2010 24%,#7a4820 50%,#4a2e14 74%,#1a0e08 100%)',
    color: '#7a4820',
    figures: [
      { id:'lady',      name:'虢国夫人', en:'Lady Guoguo',      pose:'Near-frontal', rec:true },
      { id:'attendant', name:'侍女',     en:'Lady Attendant',   pose:'Near-frontal', rec:true },
      { id:'rider',     name:'骑马侍从', en:'Mounted Escort',   pose:'3/4 turn',     rec:false },
    ],
    youAre: '侍女 · Lady Attendant',
    context: "Zhang Xuan's original is lost; this is a Song dynasty copy of Lady Guoguo — favorite sister of Yang Guifei, the Emperor's beloved consort — riding out in spring with her retinue. The painting captures the peak of Tang aristocratic splendor, just years before the An Lushan Rebellion shattered the dynasty.",
    scene: "You ride among the retinue of Lady Guoguo on a spring morning, silk robes catching the breeze. The court is resplendent, the emperor's favor absolute — and no one yet sees the storm coming.",
  },
  {
    id: 'luoshen',
                    ...
                    {imgs?.[painting?.id] && figure && (() => {
                        ...
                        return (
                          <div style={{
                            ...
                            {/* Oval showing where converted face will be pasted — matches calibrate oval */}
                            {generatedUrl && (() => {
                              const thumbW = 120, thumbH = 140;
                              // Match calibrate oval: 82% width, 84% height of region
                              const ovalW = thumbW * 0.82;
                              const ovalH = thumbH * 0.84;
                              const ovalL = (thumbW - ovalW) / 2;
                              const ovalT = thumbH * 0.13; // calibrate top offset = (1-0.84)/2 + 5% = 13%
                              return (
                                <div style={{
                                  position:'absolute',
