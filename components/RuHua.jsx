...
const PAINTINGS = [
  ...
  },
  {
    ...
    color: '#7a4820',
    figures: [
      { id:'lady',      name:'虢国夫人', en:'Lady Guoguo',      pose:'Near-frontal', rec:true,  faceRegion:{ x:0.55, y:0.10, w:0.10, h:0.35, angle:0  } },
      { id:'attendant', name:'侍女',     en:'Lady Attendant',   pose:'Near-frontal', rec:true,  faceRegion:{ x:0.35, y:0.10, w:0.09, h:0.32, angle:3  } },
      { id:'rider',     name:'骑马侍从', en:'Mounted Escort',   pose:'3/4 turn',     rec:false, faceRegion:{ x:0.15, y:0.08, w:0.09, h:0.30, angle:-5 } },
    ],
